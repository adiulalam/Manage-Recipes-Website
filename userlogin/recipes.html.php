...
<html lang= "en">
	...
	<body>
        ...
        <table>
            ...
            <td><img src="../user/img/<?php echo htmlspecialchars($Recipe['Image']);?>" style="width:300px;height:200px;"/></td>
            <td>
            <form action="?" method="post">          
                <input type="hidden" name="ID" value="<?php echo $Recipe['ID']; ?>">
                    <input type="submit" name="action" value="Edit">
                    <input type="submit" name="action" value="Delete">
                    <input type="button" value="Details" onClick="document.location.href='../user/details/'" >
            </form>   
            </td>  
            </tr>
            <?php endforeach;?>
